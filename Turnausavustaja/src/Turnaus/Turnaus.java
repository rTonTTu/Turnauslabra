...
public class Turnaus {
     ...
     */
    /**
     * Luokan muuttujat jotka hallinnoivat tärkeitä tietoja turnauksen osalta,
     * kuten päivämäärää, turnauksen nimeä sekä listaa osallistuvista
     * joukkueista
     *
     */
    ...
    /**
     * Konstruktorissa luodaan uusi turnaus, jonka yhteydessä määritellään
     * turnauksen nimi sekä päivämäärä, jolloin turnaus pelataan. HUOM! Turnaus
     * voidaan tehdä etukäteen, siksi käsin täytettävä päivämäärä
     *
